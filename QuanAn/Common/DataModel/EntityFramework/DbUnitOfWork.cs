...
namespace QuanAn.Common.DataModel.EntityFramework
{
    /// <summary>
    ...
    public abstract class DbUnitOfWork<TContext> : UnitOfWorkBase, IUnitOfWork where TContext : DbContext
    {
        ...
        {
            return Context.ChangeTracker.Entries().Any(x => x.State == System.Data.EntityState.Added || x.State == System.Data.EntityState.Deleted || x.State == System.Data.EntityState.Modified);
        }
